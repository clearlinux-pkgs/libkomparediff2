...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkomparediff2-22.08.0.tar.xz
...
%prep
%setup -q -n libkomparediff2-22.08.0
cd %{_builddir}/libkomparediff2-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661532616
mkdir -p clr-build
pushd clr-build
