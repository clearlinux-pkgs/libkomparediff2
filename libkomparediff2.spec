...
Source0  : https://download.kde.org/stable/applications/19.08.1/src/libkomparediff2-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/libkomparediff2-19.08.1.tar.xz.sig
...
%prep
%setup -q -n libkomparediff2-19.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567715806
mkdir -p clr-build
pushd clr-build
