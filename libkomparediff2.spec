...
Version  : 24.05.1
Release  : 70
URL      : https://download.kde.org/stable/release-service/24.05.1/src/libkomparediff2-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/libkomparediff2-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/libkomparediff2-24.05.1.tar.xz.sig
...
%setup -q -n libkomparediff2-24.05.1
cd %{_builddir}/libkomparediff2-24.05.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718383180
mkdir -p clr-build
pushd clr-build
