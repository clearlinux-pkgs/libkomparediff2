...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/libkomparediff2-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/libkomparediff2-24.02.2.tar.xz.sig
...
%prep
%setup -q -n libkomparediff2-24.02.2
cd %{_builddir}/libkomparediff2-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712860318
mkdir -p clr-build
pushd clr-build
