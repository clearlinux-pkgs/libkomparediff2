...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/libkomparediff2-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/libkomparediff2-24.12.2.tar.xz.sig
...
%setup -q -n libkomparediff2-24.12.2
cd %{_builddir}/libkomparediff2-24.12.2
pushd ..
cp -a libkomparediff2-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738947078
mkdir -p clr-build
pushd clr-build
